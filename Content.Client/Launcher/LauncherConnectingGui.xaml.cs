...
using Robust.Client.Configuration; // LP edit
...
namespace Content.Client.Launcher
{
    ...
    public sealed partial class LauncherConnectingGui : Control
    {
            ...
            IPrototypeManager prototype, IConfigurationManager config, IClipboardManager clipboard)
        {
            ...
            OpenDiscordButton.OnPressed += _ => IoCManager.Resolve<IUriOpener>().OpenUri(_cfg.GetCVar(CCVars.InfoLinksDiscord));
            OpenWikiButton.OnPressed += _ => IoCManager.Resolve<IUriOpener>().OpenUri(_cfg.GetCVar(CCVars.InfoLinksWiki));
            OpenWebsiteButton.OnPressed += _ => IoCManager.Resolve<IUriOpener>().OpenUri(_cfg.GetCVar(CCVars.InfoLinksWebsite));
            OpenGithubButton.OnPressed += _ => IoCManager.Resolve<IUriOpener>().OpenUri(_cfg.GetCVar(CCVars.InfoLinksGithub));
            OpenForumButton.OnPressed += _ => IoCManager.Resolve<IUriOpener>().OpenUri(_cfg.GetCVar(CCVars.InfoLinksForum));
        ...
        // LP edit start
        private void OnInitialNwVarsReceived(object? sender, System.EventArgs e)
        {
            UpdateButtonVisibility();
        }
