...
namespace Content.Client.Lobby.UI
{
    ...
    public sealed partial class HumanoidProfileEditor : BoxContainer
    {
        ...
        private async void ImportProfile()
        {
            ...
            try
            {
                var profile = HumanoidCharacterProfile.FromStream(file, _playerManager.LocalSession!, SponsorSimpleManager.GetMarkings(), SponsorSimpleManager.GetTier(), SponsorSimpleManager.GetUUID());    //LP edit
