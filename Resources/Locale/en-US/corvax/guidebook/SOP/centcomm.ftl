...
guidebook-SOP-centcomm-general-must =
    ...
    1. В случае критической ситуации направлять Полевого Офицера Центрального Командования (ПОЦК) на станцию для личного урегулирования проблем.
...
guidebook-SOP-CentralCommandOfficial-right =
    ...
    1. Принимать меры по защите имущества и интересов ЦентКом, включая задержание или отстранение членов экипажа.
...
guidebook-SOP-BlueshieldOfficer-must =
    ...
    1. Обеспечивать безопасность Представителя ЦентКома, а также выполнять его правомерные приказы.
...
## Представитель ЦентКом

guidebook-SOP-NanotrasenRepresentative-must =
    1. Выполнять прямые законные указания Центрального Командования.
    1. Обеспечить представительство от лица ЦентКом в случае возникновения на объекте [tooltip="guidebook-SOP-centcomm-tooltip-ntr-nonstandard-conditions" text="нестандартных условий"].
    ...
    1. Проводить оценку эффективности работы каждого отдела станции и искусственного интеллекта не менее одного раза за смену.
      - ПЦК обязан уведомить главу отдела о проведении оценки эффективности за 5 минут до проверки.
...
guidebook-SOP-NanotrasenRepresentative-right =
    ...
    1. Хранить при себе и использовать для исправления заверенных документов ручку «центком»:
      ...
      - В изменённом документе должно быть добавлено [tooltip="guidebook-SOP-centcomm-tooltip-ntr-edit-note" text="примечание о редактировании"], он должен быть заверен печатью ПЦК.
guidebook-SOP-NanotrasenRepresentative-prohibited =
    ...
    1. Самостоятельно выносить вердикты по полученным жалобам.
      - Представитель ЦентКома имеет право предпринимать попытки локального урегулирования и исключить обращения на Центральное Командование.
...
guidebook-SOP-centcomm-infobox =
    ...
    { "[bold]Исключение начальные роли станции[/bold]: офицер синего щита, представитель ЦентКома. Для них СРП всегда актуально, общие процедуры ЦК не распространяются." }
# Tooltip
...
guidebook-SOP-centcomm-tooltip-ntr-valuable-items =
    ...
    1. Переносной факс.
guidebook-SOP-centcomm-tooltip-ntr-edit-note = В документ над полем для печатей должна быть добавлена строка, в которой будет указано, что документ был отредактирован; в строке должны быть указаны И/Ф ПЦК.
