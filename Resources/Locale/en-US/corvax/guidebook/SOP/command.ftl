...
guidebook-SOP-command-general-right =
    ...
    1. Создавать правила работы в отделе на свое усмотрение и отдавать правомерные приказы сотрудникам, если они не противоречат Стандартным Рабочим Процедурам, не уменьшают эффективность отдела и не создают в нём токсичную обстановку.
      ...
      - Капитан уполномочен ограничить реализацию дозволений любого сотрудника станции, кроме АВД, ПЦК, ПОЦК, ОСЩ.
    ...
    1. Изменять заработную плату подчинённых сотрудников, но не более, чем на 20% от стандартного оклада.
      - Капитан имеет право изменять заработную плату любого сотрудника станции вплоть до 35% от стандартного оклада, кроме АВД, ПЦК, ПОЦК, ОСЩ.
...
guidebook-SOP-Captain-right =
    1. [bold]Вето.[/bold] капитан может отменить приказ и решение любого сотрудника станции, кроме решений, принятых советом глав, а также решений, отданных АВД, ПЦК, ПОЦК, ОСЩ.
      - Печать или приказ капитана заменяют собой печать или приказ любого сотрудника станции за исключением агента внутренних дел и Представителя ЦентКома.
...
guidebook-SOP-command-protocol-evacuation-unable-to-complete-goal = Решение об окончании смены без выполнения цели и отбытии со станции принимается исключительно капитаном под его полную ответственность.
...
guidebook-SOP-command-protocol-evacuation-zombie-virus-outbreak = До полного устранения угрозы эвакуационный шаттл не вызывается. В случае вызова шаттла центральным командованием, шаттл должен быть отклонён и запрошена помощь РХБЗЗ.
# Tooltip
guidebook-SOP-command-tooltip-neutralization =
...
guidebook-SOP-command-tooltip-srp-of-position =
    Примеры:
    - Врач - патологоанатом, хирург, вирусолог;
    - Офицер - пилот, помощник смотрителя.
guidebook-SOP-command-tooltip-dead-title =
    Примеры:
    - Смотритель - Мертв;
    - Капитан - Мертв.
