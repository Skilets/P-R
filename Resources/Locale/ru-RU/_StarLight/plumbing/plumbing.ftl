...
plumbing-reactor-temperature = Целевая темп:
plumbing-reactor-set = Уст.
plumbing-reactor-reset = Сброс
...
plumbing-filter-enabled = Включено
plumbing-filter-disabled = Отключено
...
plumbing-synthesizer-enabled = Включено
plumbing-synthesizer-disabled = Отключено
