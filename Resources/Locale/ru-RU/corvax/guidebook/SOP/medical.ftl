...
guidebook-SOP-MedicalDoctor-prohibited = 1. Покидать медицинский отдел при наличии пациентов, которым необходима помощь.
...
guidebook-SOP-Psychologist-prohibited = 1. Использовать лекарственные методы лечения без согласия пациентов.
...
guidebook-SOP-MedicalIntern-prohibited = 1. Работать с криокапсулами, оборудованием для клонирования, химической лабораторией и вирусологией без разрешения наставника.
